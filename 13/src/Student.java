...
public class Student {
	...
	public static void listToMap() {
		Student s1 = new Student(101, "王五", 20, "女");
		Student s2 = new Student(102, "李四", 23, "男");
		Student s3 = new Student(103, "张三", 25, "男");
		Student s4 = new Student(104, "张伟", 24, "男");
		Student s5 = new Student(105, "李亚", 16, "女");
	...
	public static void mapToList() {
		Student s1 = new Student(1, "王五", 20, "女");
		Student s2 = new Student(2, "李四", 23, "男");
		Student s3 = new Student(3, "张三", 25, "男");
		Student s4 = new Student(4, "张伟", 24, "男");
		Student s5 = new Student(5, "李亚", 16, "女");
